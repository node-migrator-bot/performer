// This core functionality is lifted from documentcloud's Underscore.
// Eventually there will be multiple builds making it possible to use
// Underscore proper if it is present.
define(function() {
