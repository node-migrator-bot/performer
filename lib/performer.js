define(function(require) {
  ...
  Performer.Pipelines.bootstrap_tag = require('performer/pipelines/bootstrap_tag');
  Performer.Pipelines.bootstrap_group = require('performer/pipelines/bootstrap_group');
