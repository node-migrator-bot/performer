define(['performer'],function(Performer) {
  ...
  describe('Performer.Transform.Wrap', function() {
    ...
    beforeEach(function() {
      ...
      tag = new Performer.Tag(form,'input');
    });
    ...
    describe('li', function() {
      ...
      it('should wrap input.read() with <li></li> and pass the result to output.write()', function() {
    ...
    describe('div', function() {
      ...
      it('should wrap input.read() with <div></div> and pass the result to output.write()', function() {
    ...
    describe('p', function() {
      ...
      it('should wrap input.read() with <p></p> and pass the result to output.write()', function() {
    ...
    describe('span', function() {
      ...
      it('should wrap input.read() with <span></span> and pass the result to output.write()', function() {
