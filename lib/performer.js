define(function(require) {
  ...
  Performer.Blueprints.html5 = require('performer/blueprints/html5');

  // Prepare some standard Pipelines
  Performer.Pipelines = {};
  Performer.Pipelines.bare = require('performer/pipelines/bare');
  Performer.Pipelines.bootstrap = require('performer/pipelines/bootstrap');
