...
function(_, Blueprint, Schema, Tag, Pipeline) {
  ...
  var Form = function(schema, values, options) {
    ...
    if(!this.options.blueprint ||
      ...
      throw new Error("Cannot create Form without valid Blueprint and Pipeline.");
    } else {
    ...
    this.build = function(context, traverse, recurse_from) {
      ...
      _.each(context._node,function(source, id) {
        ...
        // get blueprint (if any) and create tag
