...
var jasmine = require('../vendor/jasmine-1.1.0/jasmine').jasmine;
...
global.describe = require('../vendor/jasmine-1.1.0/jasmine').describe;
global.it = require('../vendor/jasmine-1.1.0/jasmine').it;
global.expect = require('../vendor/jasmine-1.1.0/jasmine').expect;
